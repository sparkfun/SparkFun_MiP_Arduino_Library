...
void MiP::playSingleSound(Sounds sound, uint8_t delay){
	uint8_t data_array[3];
	data_array[0] = 0x06; //Play sound command from WowWee documentation
	data_array[1] = sound; //User selected sound
	data_array[2] = delay; //User selected delay
...
void MiP::setMiPPosition(uint8_t position){
...
// Private Functions
int8_t MiP::sendMessage(uint8_t *message){
	int8_t status;
